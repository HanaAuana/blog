...
xml.feed "xmlns" => "http://www.w3.org/2005/Atom" do
  ...
  xml.link "href" => URI.join(site_url, "/blog/"+current_page.path), "rel" => "self"
  ...
  @articles.each do |article|
    xml.entry do
      ...
      xml.link "rel" => "alternate", "href" => URI.join(site_url, "/blog/"+article.url)
      xml.id URI.join(site_url, "/blog/"+article.url)
